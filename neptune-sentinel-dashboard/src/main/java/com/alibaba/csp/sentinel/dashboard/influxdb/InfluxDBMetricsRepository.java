...
public class InfluxDBMetricsRepository implements MetricsRepository<MetricEntity> {
    ...
    public List<MetricEntity> queryByAppAndResourceBetween(String app, String resource, long startTime, long endTime) {
        ...
        List<MetricDto> metricPOS = InfluxDBUtils.queryList(SENTINEL_DATABASE, sql.toString(), paramMap, MetricDto.class);

        if (CollectionUtils.isEmpty(metricPOS)) {
            return results;
        }

        for (MetricDto metricPO : metricPOS) {
    ...
    private MetricEntity convertToMetricEntity(MetricDto metricPO) {
